...
- El ciclo de vida de los workers es gestionado limpiamente por `core/app_controller.py`, independizando la lógica de la vista visual `ui/main_window.py`.
...
## 7. AI Coach
Un módulo especializado (`services/coach.py`) invocable desde la interfaz que consulta la base de datos SQLite con la transcripción entera, evalúa tu desempeño con un LLM de evaluación crítica (midiendo Claridad, Ejemplos y Precisión Técnica), y devuelve un diagnóstico para pulir tus habilidades comunicativas.
